...
```bash
npm install @stdlib/stats-base-ndarray-dstdevtk
```
...
```javascript
var dstdevtk = require( '@stdlib/stats-base-ndarray-dstdevtk' );
```
...
```c
#include "stdlib/stats/base/ndarray/dstdevtk.h"
```

#### stdlib_stats_dstdevtk( arrays )
...
double v = stdlib_stats_dstdevtk( arrays );
// returns ~2.0817
...
```c
double stdlib_stats_dstdevtk( const struct ndarray *arrays[] );
```
